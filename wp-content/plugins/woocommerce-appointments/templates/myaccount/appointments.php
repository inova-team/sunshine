				...
				<?php foreach ( $table['appointments'] as $appointment ) : ?>
					...
					<tr>
						...
						<td class="appointment-actions" data-title="<?php esc_html_e( 'Actions', 'woocommerce-appointments' ); ?>">
							...
							<a href="<?php echo esc_url( $appointment->get_reschedule_url() ); ?>" class="woocommerce-button button reschedule"><?php esc_html_e( 'Reschedule', 'woocommerce-appointments' ); ?></a>
							<?php endif ?>
						</td>
					</tr>
				<?php endforeach; ?>
